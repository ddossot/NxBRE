namespace org.nxbre.util
{
	...
	public abstract class Parameter {
		...
		public static string BuildFunctionSignature(string functionName, object[] arguments) {
			string functionSignature = functionName.Split(PARENTHESIS)[0];
			int posFirstColumn = functionSignature.IndexOf(COLUMN);
				if (posFirstColumn >= 0) functionSignature = functionSignature.Substring(posFirstColumn + 1);
